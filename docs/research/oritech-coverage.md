...
- **Core, standalone** — burner machines, the ore patch itself (amount and placement), lava as an infinite fluid.
...
What stays core is **data a block must hold**: an ore amount and lava treated as infinite. Oritech has no block that holds a quantity. What moves is the
